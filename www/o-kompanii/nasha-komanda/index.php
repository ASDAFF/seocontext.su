...
$APPLICATION->SetPageProperty("title", "SeoContext - ведущее Digital-агенство в России");
$APPLICATION->SetTitle("SeoContext - ведущее Digital-агенство в России");?><?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"SEF_MODE" => "Y",
		"SEF_FOLDER" => "/o-kompanii/nasha-komanda/",
		"DETAIL_URL" => "",
